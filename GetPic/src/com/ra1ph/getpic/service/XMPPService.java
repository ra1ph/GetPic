...
public class XMPPService extends Service {
    ...
    public static final int GET_PICTURE = 0x60;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            switch (code) {
                ...
                case GET_PICTURE:
                    mes = new com.ra1ph.getpic.message.Message(null,null,0,0);
                    mes.type = com.ra1ph.getpic.message.Message.MessageType.GETPIC;
                    task.addMessage(mes);
                    break;
            }
        }
